...
values = ["Value 1", "Value 2", "Value 3", "Value 4", "Value 5", 'dw','wdwd','ssww','wdwdw','wdw']

# create a label for the combobox
label = tk.Label(window, text="Select values:")

# create a combobox
value_list = tk.StringVar(window)
combobox = ttk.Combobox(window, state="readonly",textvariable=value_list)
